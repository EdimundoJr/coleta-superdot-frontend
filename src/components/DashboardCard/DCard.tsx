...
export default function Dcard({ title, description, iconBase, style, seeButton, linkTo, colorBadge, styleButton }: DcardProps) {
  ...
  return (
    ...
    <Grid columns="1" className={`${style} min-w[350px] rounded overflow-hidden bg-white rounded-b-lg border-t-8  shadow-md hover:translate-y-[3px] group group/item transition-all pt-4 hover:drop-shadow-[0_4px_16px_rgba(22,22,22,0.1)] font-roboto`}>
      ...
      <Flex justify="end" className={`group/edit invisible group-hover/item:visible`}>
        <button

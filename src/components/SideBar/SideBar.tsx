...
{/* // <NavigationMenu.Item className={`mb-[20px] p-2 hover:bg-[#9873FA] hover:rounded ${isActive("/app/home")}`}>
                    //     <Link to="/app/home" className={`flex gap-3 ${!expanded && ""}`}>
                    //         <Icon.SquaresFour weight={`${isActiveIcon("/app/home")}`} size={24} />
                    //         {expanded && <h2 className={`origin-left duration-300 ${!expanded && "scale-0"} `}>Dashboard</h2>}

                    //     </Link>
                    // </NavigationMenu.Item>
                    // <NavigationMenu.Item className={` p-2 mb-[20px] hover:bg-[#9873FA] hover:rounded ${isActive("/app/my-samples", "/app/analyze-sample", "/app/seconds-source-compare", "/app/participants-registration", "/app/evaluate-autobiography")}`}>
                    //     <Link to="/app/my-samples" className="flex gap-3">
                    //         <Icon.Books weight={`${isActiveIcon("/app/my-samples", "/app/analyze-sample", "/app/participants-registration", "/app/seconds-source-compare", "/app/evaluate-autobiography")}`} size={24} />
                    //         <h2 className={`origin-left  duration-300 ${!expanded && "scale-0"} `}>Minhas Amostras</h2>
                    //     </Link>
                    // </NavigationMenu.Item>
                    // <NavigationMenu.Item className={`flex  mb-[20px] p-2 hover:bg-[#9873FA] hover:rounded ${isActive("/app/create-sample", "/app/choose-sample-group")}`}>
                    //     <Link to="/app/create-sample" className="flex gap-3">
                    //         <Icon.FolderSimplePlus weight={`${isActiveIcon("/app/create-sample", "/app/choose-sample-group")}`} size={24} />
                    //         <h2 className={`origin-left ${!expanded && "scale-0"} duration-300`}>Criar Amostras</h2>
                    //     </Link>
                    // </NavigationMenu.Item>
                    // {userRole.match("Revisor|Administrador") && ( */}
//     <>
//         <NavigationMenu.Item
//             className={`flex items-center p-2 mb-[20px] hover:bg-[#9873FA] hover:rounded ${isActive("/app/review-requests")}`}
//         >
//             <Link to="/app/review-requests" className="flex gap-3">
//                 <Icon.Check weight={`${isActiveIcon("/app/review-requests")}`} size={24} />
//                 <h2 className={`origin-left ${!expanded && "scale-0"} duration-300`}>Revisar solicitações</h2>
...
// {userRole === "Administrador" && (
//     <>
//         <NavigationMenu.Item className={`flex items-center mb-[20px] p-2 hover:bg-[#9873FA] hover:rounded ${isActive("/app/users")}`}>
//             <Link to="/app/users" className="flex gap-3">
//                 <Icon.UserGear weight="thin" size={24} />
//                 <h2 className={`origin-left ${!expanded && "scale-0"} duration-300`}>Usuários</h2>
//             </Link>
...
//             className={`cursor-pointer duration-500 ${expanded && "rotate-[360deg]"
//                 }`}
//         />
//         <h1
//             className={`text-white origin-left font-medium text-xl duration-200 ${!expanded && "scale-0"
//                 }`}
//         >
//             Designer
//         </h1>

...
const Notify = ({ open, onOpenChange, title, description, children, icon, className }: NotifyProps) => {
    return (
        ...
        <Toast.Provider>
            ...
            <Toast.Viewport className="[--viewport-padding:_35px] fixed bottom-0 right-0 flex flex-col p-[var(--viewport-padding)] gap-[10px] w-[450px] max-w-[100vw] m-0 list-none z-[2147483647] outline-none" />
        </Toast.Provider>
